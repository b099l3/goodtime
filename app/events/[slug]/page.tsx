    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="text-primary p-8 bg-gradient-to-r from-primary to-primary/60">
        <div className="container">
          <h1 className="text-5xl font-bold mb-2 text-primary-foreground">
            {event.fields.title}
          </h1>
        </div>
      </div>
          ...
          <div className="bg-muted/30 rounded-lg p-6">
              ...
              <a
                ...
                href={
                  event.fields.location
                    ? `https://www.google.com/maps/search/?api=1&query=${event.fields.location.lat},${event.fields.location.lon}`
                    : "#"
                }
              >
                <div className="flex items-center gap-2">
            ...
            {event.fields.gpxFile && (
              <div className="mb-10">
                <GpxMapWrapper
                  gpxUrl={`https:${
                    (event.fields.gpxFile as Asset).fields?.file?.url ?? ""
                  }`}
                />
              </div>
            )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 p-12">
            {event.fields.registerLink && (
              <Button size="lg" className="flex-3" asChild>
                <a target="_blank" href={event.fields.registerLink}>
